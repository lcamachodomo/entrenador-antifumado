...
public class AdviceNotificationService extends Service {
    public AdviceNotificationService() {
    }
    ...
    public class MyBinder extends Binder {
        AdviceNotificationService getService() {
            return AdviceNotificationService.this;
        }
    }
}
